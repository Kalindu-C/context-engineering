...
✅ **Follows** Zuu Crew AI architecture for clean, maintainable code  
...
### Zuu Crew AI Architecture (Dev Level)
...
│
├─ src/
│  └─ context_engineering/                  # Main package (Zuu Crew AI structure)
...
│  ├─ AGENT_API_BOOTSTRAP_PROMPT.md         # Zuu Crew AI template guide
...
├─ template.py                              # Zuu Crew AI project generator
...
### Zuu Crew AI Standard (Dev Level)
...
| [AGENT_API_BOOTSTRAP_PROMPT.md](./docs/AGENT_API_BOOTSTRAP_PROMPT.md) | Zuu Crew AI architecture template |
